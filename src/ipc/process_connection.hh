...
#pragma once
#ifndef B8cgxrahizioQqTHcqGfQsp8maiOU0B3
#define B8cgxrahizioQqTHcqGfQsp8maiOU0B3
...
class base_connection
{
    ...
    public:
      ...
      void redirect_stderr_to_default()                          { impl().set_stderr_default(); }
      void redirect_stderr_to_devnull()                          { impl().set_stderr_devnull(); }
      void redirect_stderr_to_fd(err_descriptor_type const fd)   { impl().set_stderr_fd(fd); }
      void redirect_stderr_to_filename(std::string const &fname) { impl().set_stderr_filename(fname); }
