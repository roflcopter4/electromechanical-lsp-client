...
extern "C" { extern pthread_mutex_t util_c_error_write_mutex; }
...
#  define err(EVAL, ...)  emlsp::util::my_err_throw((EVAL), true,   __FILE__, __LINE__, __PRETTY_FUNCTION__, __VA_ARGS__)
#  define errx(EVAL, ...) emlsp::util::my_err_throw((EVAL), false,  __FILE__, __LINE__, __PRETTY_FUNCTION__, __VA_ARGS__)
#else
